...
public class TreatedEntryDetail  implements java.io.Serializable {
	...
	private List<TreatedEntryDetailDestination> treatedEntryDetailDestinations  = new ArrayList<TreatedEntryDetailDestination>();
	...
	public List<TreatedEntryDetailDestination> getTreatedEntryDetailDestinations() {
		return treatedEntryDetailDestinations;
	}

	public void setTreatedEntryDetailDestinations(
			List<TreatedEntryDetailDestination> treatedEntryDetailDestinations) {
